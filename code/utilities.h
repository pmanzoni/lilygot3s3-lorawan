...
bool initPMU() {
    ...
    if (PMU->getChipModel() == XPOWERS_AXP192) {
        ...
        // In order to avoid bus occupation, during initialization, the SD card
        // and QMC sensor are powered off and restarted
    ...
    // board without the battery temperature detection function, otherwise it
    // will cause abnormal charging
